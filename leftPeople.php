      ...
      <div class="container">
        <div class="row">
          ...
          <div class="background">
              ...
              <div class="bir box" style="margin-left:350px;margin-top:-80px">
                  ...
                  <div class="col-md-4">
                      ...
                      <?php
                           ...
                           {
                               echo "Failed to connect to MySQLsss: " . mysqli_connect_error();
                           }

                           $result = mysqli_query($con,"SELECT FirstName_left  ,  	lastName_left , loan FROM leftpersons ");
...
<th>Loan</th>
                           ...
                           {
                               echo "<tr>";
                               echo "<td>" . $row['FirstName_left'] . "</td>";
                               echo "<td>" . $row['lastName_left'] . "</td>";
                               echo "<td>" . $row['loan'] . "</td>";
                               echo "</tr>";
                           }
                           echo "</table>";
