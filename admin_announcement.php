...
<html lang="en">
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
         <ul>
            ...
            <li><a href="admin_announcement.php" class="active" ><i class="fa fa-database fa-fw"></i>Announcements</a></li>
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1">The announcement text</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" name="textt" rows="3"></textarea>
  </div>
