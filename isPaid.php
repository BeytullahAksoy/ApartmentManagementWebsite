          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
             <ul class="text-uppercase">
                ...
                <li><a href="isPaid.php" class="active">Previous Payments</a></li>
...
payments.amount,payments.date FROM users inner join payments on users.userID = payments.userID where   YEAR(date) = '$year' and MONTH(date)= '$month' ");
