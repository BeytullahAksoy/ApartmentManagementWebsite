...
@media screen and (max-width: 600px) {
  ...
  <body>
    ...
    <div class="single-services">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
          <div class="background" style="width:800px;margin-left:400px">
 

             <div class="üç box" style="width:300000px">
 ...
 <div style="" ><p > List of loans collected from members </p></div>
...
if(isset($_GET['file'])){
    ...
    $result = mysqli_query($con,"SELECT accounts.FirstName, accounts.lastName , payments.amount ,payments.theDate
FROM accounts
    INNER JOIN payments ON accounts.id = payments.account_id where YEAR(theDate) = '$year' and MONTH(theDate)= '$month' ");
...
FROM payments  where YEAR(theDate) = '$year' and MONTH(theDate)= '$month'
")) {
            $stmt->execute();
            $stmt->store_result();
