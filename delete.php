      ...
      <div class="container">
        <div class="row">
          ...
          <div class="background">
              ...
              <img src="assets/images/product-5-720x480.jpg" alt="" style="margin-left:400px ;width:250px;height:130px">
                  <br />
              <div class="down-content" style="margin-left:400px">
                  <br />
                <h4 style="margin-left:30px">Delete Member</h4>
                  <br />
...
<br>
<br>
<input type="submit" name="submit" value="Delete" style="margin-left:90px"> 
