...
@media screen and (max-width: 600px) {
 ...
 <div class="yedi box">
            ...
            <div class="service-item">
                <img src="assets/images/product-7-720x480.jpg" alt="" style="margin-left:400px ; margin-top:-100px" />
                <div class="down-content" style="margin-left:440px;width:200px" >
                    ...
                    <div id="addDiv" >
                        <form action="addMember.php" method="post">
                           <div style="margin-left:-20px">User Name:
<input type="text" name="userName-r" style="width :180px;height:20px"  />
<p></p></div>
                            
                             <div style="float:left">
                            Password:
                            <input type="text" name="password-r" style="width :180px;height:20px;margin-left:-20px"  />
                            <p></p></div>
                            <div style="margin-left:-20px">email:
<input type="text" name="email-r" " style="width :180px;height:20px" />
<p></p></divstyle="float:left">
                           
                            Phone :
                            <input type="text" name="phone-r" style="width :180px;height:20px;"  />
                            <p></p>
                            Admin:
                            <input type="text" name="admin-r" style="width :180px;height:20px;"  />

                            <p></p>
                            Floor:
                            <input type="text" name="floor-r" style="width :180px;height:20px"  />
                            
                            Number :
                            <input type="text" name="number-r" style="width :180px;height:20px"  />
                            <p></p>
                            First Name :
                            <input type="text" name="firstName-r" style="width :180px;height:20px"  />
                            <p></p>
                            Last Name :
                            <input type="text" name="lastName-r" style="width :180px;height:20px"  />
