...
@media screen and (max-width: 600px) {
  ...
  <div class="container">
              ...
              <div class="altı box" style="margin-left:200px">
                  <div class="service-item">
              <img src="assets/images/product-6-720x480.jpg" alt="" style="width:500px">
              <div class="down-content">
                <h4 style="margin-left:100px">Add Announcement</h4>
               <form action="announcement.php" method="post"  >
   
Text: <textarea name="textt" style="width: 270px;margin-left:20px " />
 ...
 <input type="submit" value="Submit Announcement" style="margin-left:100px" />
