...
@media screen and (max-width: 600px) {
 ...
 <div class="sub-header">
    ...
    <div class="iki box" style="margin-left:600px" >
                  <div class="col-md-4">
            <div class="service-item">
              <img src="assets/images/product-4-720x480.jpg" alt="" style="height:200px;width:200px">
 ...
 <input type="text" name="masraf" style="width: 180px" /><br/>
                   Explaining <br />
 <input type="text" name="explain" style="width: 180px" />
